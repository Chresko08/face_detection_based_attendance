...
lbl = Label(window, text="Enter id", width=20, height=2, fg="black", font=('times', 20, 'italic bold '))
...
#lbl2 = Label(window, text="Enter Name", width=20, fg="black",  height=2, font=('times', 20, 'italic bold '))
